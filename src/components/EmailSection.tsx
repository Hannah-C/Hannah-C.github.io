    ...
    try {
      await fetch("/api/send", {
        ...
        if (resp.status === 200) {
          ...
          console.log("Server error:"); // Log the error response
        }
      });
  ...
  return (
    ...
    >
      ...
      <div className="z-10">
        ...
        <p className="text-hannahs-text mb-4 max-w-md">
        ...
        <div className="socials flex flex-row gap-2 text-white">
          ...
          <Link
            href="https://www.linkedin.com/in/hannahchoicsart/"
            passHref={true}
          >
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <input
                ...
                id="email"
                required
                className="bg-[#18191E] border boder-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
